var test_onFinish = function(){
    var queue_onfinish = OneLib.ScriptLoader.beginQueue('3 modules').
        load('../demoData/OneLib.ScriptLoader/module_b.js').//加载文件1.js
        load('../demoData/OneLib.ScriptLoader/module_b2.js').//加载文件2.js
        load('../demoData/OneLib.ScriptLoader/module_b3.js');//加载文件3.js
