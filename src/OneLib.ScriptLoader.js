...
//                    self.script.onreadystatechange == null;
     ...
     */
    __pub__.loadScript = function(url,callback,charset){
...
//                }
     ...
     */
    __pub__.beginQueue = function(queueName,initFiles){
     ...
     * @param queueName
     */
    __pub__.theQueue = function(queueName){
        return _allQueue[queueName];
    };
    
    __pub__.getAllQueue = function(){
        return _allQueue;
    };
